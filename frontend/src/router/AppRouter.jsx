...
const SugarTrackerPage = lazy(() => import('../features/tracker/SugarTrackerPage'));
const AlcoholVerificationPage = lazy(() => import('../features/verification/AlcoholVerificationPage'));
const WaterVerificationPage = lazy(() => import('../features/verification/WaterVerificationPage'));
const ScanProductPage = lazy(() => import('../features/scan/ScanProductPage'));
const ProductResultPage = lazy(() => import('../features/scan/ProductResultPage'));
