          ...
          <CardContent sx={{ p: { xs: 3, md: 4 } }}>
            ...
            {step === 0 && (
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                <Typography sx={{ fontWeight: 700, fontSize: '1.125rem', color: 'text.primary', mb: -1 }}>Incident Details</Typography>

                {/* Risk Category */}
                <Box>
                  <Typography sx={{ fontSize: '0.875rem', fontWeight: 600, color: 'text.primary', mb: 1 }}>Risk Category</Typography>
                ...
                {/* Product Name */}
                <Box>
                  <Typography sx={{ fontSize: '0.875rem', fontWeight: 600, color: 'text.primary', mb: 1 }}>Product Name or UPC</Typography>
                  <TextField
                ...
                {/* Description */}
                <Box>
                  <Typography sx={{ fontSize: '0.875rem', fontWeight: 600, color: 'text.primary', mb: 1 }}>Detailed Description</Typography>
                  <TextField
            ...
            {step === 1 && (
              <Box sx={{ py: 6, textAlign: 'center' }}>
                ...
                <Typography sx={{ fontWeight: 700, fontSize: '1.125rem', color: 'text.primary', mb: 1 }}>Upload Evidence</Typography>
                <Typography sx={{ color: 'text.secondary', fontSize: '0.9375rem' }}>Attach photos, receipts, or other supporting documents.</Typography>
              </Box>
            )}
